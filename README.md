...
> **`base` 稳定底座**(`view="base"`,单独打印,套在最底层单元底销上):前伸 130mm、后伸 95mm,把前支点推到 Y=196mm → 满载前向裕度 **133mm**,临界前倾角抬到 **单体 45°、4 层 16°、8 层 8°**。底座底面掏空(外圈+十字肋),约 447cc(≈140g)。≥5 层的高塔建议**另加墙锚点**或降低堆叠层数。
