...
MOUTH_CLEAN = 16.0    # 盆口最顶一圈强制 0 起伏的"光滑唇"宽(mm): 起伏达2.7mm, 需≥1个元胞(16.7mm)宽才能在低角度也不露鳞片
MOUTH_TAPER = 12.0    # 光滑唇之下的羽化过渡宽(mm): 由唇内沿向下 0→满, 平滑接上正常纹理
...
_SIDEG=29.9; _MODW=_OUTT+2*_SIDEG; _CX=_MODW/2   # 与 .scad 同步(加宽: mod_w=200)
_ZDIP=_WALL+_RESH-_LENS
_POT_DY=7.65; _POT_DZ=0   # 与 .scad pot_dy/pot_dz 同步(花盆+Y平移使打印盆口贴板)
_P0Y=(_OUTB/2)*_AZ-_FLOOR*_AY-_PBACK+_POT_DY
_P0Z=_ZDIP-_FLOOR*_AZ+(_INB/2)*_AY+_POT_DZ
